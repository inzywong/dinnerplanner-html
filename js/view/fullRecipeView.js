...
var FullReceipeView = function (container, model){
   ...
   this.update = function()
   {
      ...
      {
         container.append("<div class='row'> <div class='col-md-3'> <img src='images/" + dishesSelected[i].image + "' style='width:150px; height: 150px'> </div> <div class='col-md-4'> <h5>" + dishesSelected[i].name + "</h5> <p>" + dishesSelected[i].description + "</p> </div>  <div class='col-md-5'> <h5>Preperations</h5> <p>" + dishesSelected[i].description + "</p> </div> </div>");
      }      
   }
