 ...
 */  
   ...
   this.update = function()
   {
      ...
      for(var i=0; i< dishesSelected.length; i++)
      {
		  d.append("<div class='row'><div class='col-md-1'></div> <div class='col-md-2'> <img src='" + dishesSelected[i].image + "' style='width:150px; height: 150px'> </div> <div class='col-md-4'> <h5>" + dishesSelected[i].title + "</h5> <p>" + dishesSelected[i].instructions + "</p> </div>  <div class='col-md-4'> <h5>Preperations</h5> <p id='prep_" + i + "'>" +dishesSelected[i].instructions+"</p> </div> <div class='col-md-4></div></div>");
