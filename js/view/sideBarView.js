...
var SideBarView = function (container, model) 
{
    ...
    this.update = function()
    {
        ...
        {
            dishNameCostDiv.append("<div class = 'row'> <div  class='col-md-6 noPadding' style='float:left' > <p style='text-align:left'>"+ selectedDishes[i].title + " </p> </div>" + "<div class='col-md-6'> <p style='text-align:right'>"+ selectedDishes[i].pricePerServing*model.getNumberOfGuests() + " SEK</p> </div> </div>");	
