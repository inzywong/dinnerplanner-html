...
{     
   ...
   {	   
       // Hiding everything inside the  #dishDetailsRowContainer
	   container.find("#dishDetailsRowContainer").hide();
	   container.find("#preparationRow").hide();
	   
	   container.find(".loading_dishDetails").remove();	   
	   container.find("#dishDetailsColumnContainer").append("<div class='row loading_dishDetails' ><center><img src='https://media1.tenor.com/images/8ac12962c05648c55ca85771f4a69b2d/tenor.gif?itemid=9212724'></center></div>");
   ...
   {	   
	   ...
	   dishDescription.html(selectedDish.creditsText);
	   preparation.html(selectedDish.instructions);
      ...
      this.addToMenuButton = container.find("#add_to_menu");  
   // Hiding everything inside the  #dishDetailsRowContainer
   container.find("#dishDetailsRowContainer").show();
   container.find("#preparationRow").show();
   ...
   this.errorCb = function()
   {
    ...
    container.find("#preparationRow").hide();
    container.find(".loading_dishDetails").remove();	   
	container.find("#dishDetailsColumnContainer").append("<div class='row loading_dishDetails' ><center><img src='http://zoofitech.com/assets/frontend/dist/images/404.png'></center></div>");
console.log("error");
